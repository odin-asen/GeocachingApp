...
/**
 * Limits returned geocache to those with a size rating between
 * a minimum and a maximum value inclusive.
 * <p/>
 * Author: Timm Herrmann<br/>
 * Date: 16.04.13
 */
public class Size extends ComOpencachingParameter {
  ...
  /* Constructors */
  /**
   * Creates the size parameter. {@code min} should be smaller than or
   * equal to {@code max}.
   * The domain of these values are decimal numbers from 1 to 5.
   * @param min Minimum value of the range.
   * @param max Maximum value of the range.
   */
  public Size(float min, float max) {
